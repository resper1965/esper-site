  ...
  (
    ...
    return (
      <section
        ref={ref}
        className={cn(
          "relative z-0 flex min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 md:pb-16",
          className,
        )}
        {...props}
      >
        ...
        <motion.div
          ...
          className="relative z-50 container flex justify-center flex-1 flex-col px-4 sm:px-6 md:px-10 gap-3 sm:gap-4 -translate-y-12 sm:-translate-y-16 md:-translate-y-20"
        >
          <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 md:space-y-6">
            <h1
              className={cn(
                "text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight leading-tight px-2",
                titleClassName,
              )}
            >
              {title}
            ...
            {subtitle && (
              <p
                className={cn(
                  "text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-2xl px-4 sm:px-6 leading-relaxed",
                  subtitleClassName,
                )}
              >
                {subtitle}
