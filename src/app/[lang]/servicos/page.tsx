...
export default async function Servicos({
  ...
  const services = lang === 'pt-BR' ? [
    ...
    {
      icon: Shield,
      title: "CISO Consulting",
      subtitle: "Chief Information Security Officer as a Service",
      description: "Strategic information security leadership for organizations that need executive expertise without the cost of a full-time CISO.",
      benefits: [
        "Security strategy and roadmap definition",
        "Risk management and compliance (LGPD, GDPR, SOC 2)",
    ...
    {
      icon: Eye,
      title: "Corporate Counterespionage",
      subtitle: "TSCM & Executive Protection",
      description: "Protection against sensitive information leaks, technical sweeps and communication security for executives.",
      benefits: [
        "TSCM sweeps (Technical Surveillance Countermeasures)",
        "Executive protection and international travel",
    ...
    },
    {
      ...
      subtitle: "Investigation & Incident Response",
      description: "Technical investigation of security incidents, malware analysis and collection of digital evidence with legal validity.",
      benefits: [
        "Fraud and leak investigations",
    ...
    },
    {
      ...
      subtitle: "LGPD, GDPR, HIPAA, SOC 2",
      description: "Complete regulatory compliance, from initial assessment to control implementation and compliance maintenance.",
      benefits: [
        "Gap assessment and compliance roadmap",
        "DPO as a Service implementation",
      ...
      <div className="bg-transparent">
        ...
        <div className="relative border-t border-border overflow-hidden">
          ...
          <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24 text-center">
            <h2 className="text-3xl font-bold">{dict.services.ctaTitle}</h2>
