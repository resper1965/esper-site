...
language: "pt-br"
excerpt: "Em meus 34 anos à frente da NESS, raramente vi uma ameaça evoluir tão rapidamente quanto o ransomware. O que começou como ataques oportunistas transformou-se em operações criminosas sofisticadas."
...
Em meus 34 anos à frente da [NESS](https://ness.com.br), raramente vi uma ameaça evoluir tão rapidamente quanto o ransomware. O que começou como ataques oportunistas nos anos 2000 transformou-se em operações criminosas altamente sofisticadas, com modelos de negócio que rivalizam empresas legítimas.

Como CISO da IONIC Health e com experiência em múltiplos setores críticos, testemunho diariamente o impacto devastador que essas ameaças causam. Mas também observo padrões, aprendizados e, mais importante, oportunidades de defesa efetiva.
...
Organizações que precisam de suporte especializado em segurança operacional e resposta a incidentes podem contar com serviços como os oferecidos pela [NESS](https://ness.com.br), que há mais de 34 anos desenvolve soluções de segurança da informação para empresas de todos os portes.
...
Com mais de três décadas de experiência em segurança da informação, a [NESS](https://ness.com.br) tem ajudado organizações a construir programas efetivos de segurança operacional, preparando-as para enfrentar ameaças modernas como ransomware com resiliência e eficiência.
...
*Ricardo Esper é CEO da [NESS Processos e Tecnologia](https://ness.com.br) (desde 1991), CISO da IONIC Health, e CEO da forense.io. Certificado CCISO e CEHIv8, é membro ativo de HackerOne, OWASP e da Comissão de Privacidade de Dados da OAB SP.*
